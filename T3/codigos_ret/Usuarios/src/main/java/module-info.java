module org.example.usuarios {
    ...
    opens org.example.usuarios.database to javafx.fxml;

    exports org.example.usuarios.model;
    opens org.example.usuarios.model to javafx.fxml, com.google.gson;

    exports org.example.usuarios.dao;
    opens org.example.usuarios.dao to javafx.fxml, org.json, com.google.gson;
}